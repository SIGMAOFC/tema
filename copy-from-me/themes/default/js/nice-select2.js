        ...
        return p.prototype.create = function () {
            ...
            p.prototype._renderSelectedItems = function () {
                if (this.multiple) {
                    ...
                    "auto" == window.getComputedStyle(this.dropdown).width || this.selectedOptions.length < 2 ? (this.selectedOptions.forEach((function (t) {
                        ...
                        e = "" == e ? this.placeholder : e) : e = this.selectedOptions.length + " selected",
            ...
            p.prototype.disable = function () {
                this.disabled || (this.disabled = !0,
                    l(this.dropdown, "disabled"))
            }
            ,
            p.prototype.enable = function () {
                this.disabled && (this.disabled = !1,
                    a(this.dropdown, "disabled"))
            }
            ,
            ...
            p.prototype._onItemClicked = function (e, t) {
                var i = t.target;
                r(i, "disabled") || (this.multiple ? r(i, "selected") ? (a(i, "selected"),
                    this.selectedOptions.splice(this.selectedOptions.indexOf(e), 1),
                    this.el.querySelector('option[value="' + i.dataset.value + '"]').selected = !1) : (l(i, "selected"),
            ...
            p.prototype._onKeyPressed = function (e) {
                ...
                if (32 == e.keyCode || 13 == e.keyCode)
                    ...
                    if (s) {
                        ...
                        o && (a(this.dropdown.querySelector(".focus"), "focus"),
                            l(o, "focus"))
                    } else
                        i(this.dropdown);
                    e.preventDefault()
                    ...
                    if (s) {
                        ...
                        n && (a(this.dropdown.querySelector(".focus"), "focus"),
                            l(n, "focus"))
                    } else
                        i(this.dropdown);
                    e.preventDefault()
