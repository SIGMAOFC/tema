          ...
          <div class="ticket-info">
            ...
            <p>
              @if ($ticket->status === 'Open')
                <b>{{ __('Status') }}:</b> <span
                  class="text-green-700 bg-green-100 dark:bg-green-500/20 dark:text-green-500 px-2 py-1 font-semibold leading-tight rounded-full text-xs">{{ __('Open') }}</span>
              @elseif ($ticket->status === 'Reopened')
                <b>{{ __('Status') }}:</b> <span
                  class="text-green-700 bg-green-100 dark:bg-green-500/20 dark:text-green-500 px-2 py-1 font-semibold leading-tight rounded-full text-xs">{{ __('Reopen') }}</span>
              @elseif ($ticket->status === 'Closed')
                <b>{{ __('Status') }}:</b> <span
                  class="text-red-700 bg-red-100 dark:bg-red-500/20 dark:text-red-500 px-2 py-1 font-semibold leading-tight rounded-full text-xs">{{ __('Closed') }}</span>
              @elseif ($ticket->status === 'Answered')
                <b>{{ __('Status') }}:</b> <span
                  class="text-blue-700 bg-blue-100 dark:bg-blue-500/20 dark:text-blue-500 px-2 py-1 font-semibold leading-tight rounded-full text-xs">{{ __('Answered') }}</span>
              @elseif ($ticket->status === 'Client Reply')
                <b>{{ __('Status') }}:</b> <span
                  class="text-yellow-700 bg-yellow-100 dark:bg-yellow-500/20 dark:text-yellow-500 px-2 py-1 font-semibold leading-tight rounded-full text-xs">{{ __('Client Reply') }}</span>
              @endif
            </p>
